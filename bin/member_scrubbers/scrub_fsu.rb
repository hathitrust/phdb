...
#mapper = MemberScrub::ColumnMapping.new(fsu_mono_cols)
...
#mapper = MemberScrub::ColumnMapping.new(fsu_multi_cols)
#scrubber = MemberScrub::MemberScrubber.new(:member_id=>'fsu', :mapper=>mapper, :data_type=>'multi', :min_cols=>3)
...
mapper = MemberScrub::ColumnMapping.new(fsu_serial_cols)
