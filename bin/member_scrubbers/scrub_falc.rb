...
#scrubber = MemberScrub::MemberScrubber.new(:member_id=>'miami', :mapper=>mapper, :data_type=>'mono', 
#                                           :min_cols=>2)
...
#scrubber = MemberScrub::MemberScrubber.new(:member_id=>'miami', :mapper=>mapper, :data_type=>'multi', 
#                                           :min_cols=>2)
...
scrubber = MemberScrub::MemberScrubber.new(:member_id=>'miami', :mapper=>mapper, :data_type=>'serial',
                                           :min_cols=>2)
